...
func WithRevContainerConcurrency(cc serving.RevisionContainerConcurrencyType) RevisionOption {
	return func(rev *serving.Revision) {
...
func WithLogURL(r *serving.Revision) {
...
// status orientations.
func WithRevStatus(st serving.RevisionStatus) RevisionOption {
	return func(rev *serving.Revision) {
		rev.Status = st
	}
}
...
func MarkContainerMissing(rev *serving.Revision) {
...
func MarkRevisionReady(r *serving.Revision) {
...
func WithRevisionLabel(key, value string) RevisionOption {
	return func(config *serving.Revision) {
