...
// SyncService implements service.Receiver
func (c *Receiver) SyncService(service *v1alpha1.Service) error {
...
func (c *Receiver) reconcileConfiguration(config *v1alpha1.Configuration) error {
...
func (c *Receiver) reconcileRoute(route *v1alpha1.Route) error {
