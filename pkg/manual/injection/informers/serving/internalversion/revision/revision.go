...
func Get(ctx context.Context) serving.RevisionInformer {
	untyped := ctx.Value(Key{})
	if untyped == nil {
		logging.FromContext(ctx).Fatalf(
			"Unable to fetch %T from context.", (serving.RevisionInformer)(nil))
	}
	return untyped.(serving.RevisionInformer)
}
