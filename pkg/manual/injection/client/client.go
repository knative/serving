...
import (
	...
	"knative.dev/serving/pkg/client/serving/clientset/internalversion"
)
...
func withClient(ctx context.Context, cfg *rest.Config) context.Context {
	return context.WithValue(ctx, Key{}, internalversion.NewForConfigOrDie(cfg))
}

// Get extracts the internalversion.Interface client from the context.
