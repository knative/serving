...
// systemwide default.
func StableWindow(pa *v1alpha1.PodAutoscaler, config *sharedconfig.Config) time.Duration {
	sw, ok := pa.Window()
	if !ok {
...
func MakeMetric(pa *v1alpha1.PodAutoscaler, metricSvc string, config *sharedconfig.Config) *v1alpha1.Metric {
