...
func TestReconcile(t *testing.T) {
	...
	table := TableTest{{
		...
		Objects: []runtime.Object{
			...
			pa(testNamespace, testRevision, WithHPAClass, WithTraffic, WithHasBeenActive,
		...
		WantStatusUpdates: []ktesting.UpdateActionImpl{{
			Object: pa(testNamespace, testRevision, WithHPAClass, withScales(0, 0),
				WithTraffic, WithHasBeenActive, WithPAStatusService(testRevision), WithPAMetricsService(privateSvc)),
		}},
		Key: key(testNamespace, testRevision),
	}, {
		Name: "reconcile sks",
		...
		WantStatusUpdates: []ktesting.UpdateActionImpl{{
			Object: pa(testNamespace, testRevision, WithHPAClass, WithTraffic, WithHasBeenActive, withScales(5, 3),
				WithPAStatusService(testRevision), WithPAMetricsService(privateSvc)),
		}},
		Key: key(testNamespace, testRevision),
		...
		Objects: []runtime.Object{
			pa(testNamespace, testRevision, WithHPAClass, WithTraffic, WithHasBeenActive, withScales(0, 0),
