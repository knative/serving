...
func MakeDecider(ctx context.Context, pa *asv1a1.PodAutoscaler, config *sharedconfig.Config) *scaling.Decider {
...
func GetInitialScale(asConfig *sharedconfig.Config, pa *asv1a1.PodAutoscaler) int32 {
