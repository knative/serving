...
import (
	...
	"knative.dev/serving/pkg/client/injection/informers/serving/v1/domainmapping"
	kindreconciler "knative.dev/serving/pkg/client/injection/reconciler/serving/v1/domainmapping"
...
func NewController(ctx context.Context, cmw configmap.Watcher) *controller.Impl {
	...
	handleControllerOf := cache.FilteringResourceEventHandler{
		FilterFunc: controller.FilterController(&v1.DomainMapping{}),
