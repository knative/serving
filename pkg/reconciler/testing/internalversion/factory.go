...
import (
	...
	fakeversionedservingclient "knative.dev/serving/pkg/client/serving/injection/client/fake"
	fakeservingclient "knative.dev/serving/pkg/manual/injection/client/fake"
...
func MakeFactory(ctor Ctor) Factory {
	return func(t *testing.T, r *TableRow) (controller.Reconciler, ActionRecorderList, EventList, *FakeStatsReporter) {
		...
		// TODO(dprotaso) This is for compatability with Reconciler.Base
		// having a versioned client
		ctx, _ = fakeversionedservingclient.With(ctx)
...
func ToUnstructured(t *testing.T, sch *runtime.Scheme, objs []runtime.Object) (us []runtime.Object) {
	for _, obj := range objs {
		...
		gvks, versioned, err := sch.ObjectKinds(obj)

		if !versioned {
			// TODO(dprotaso) don't fetch internal serving objects via dynamic client
			continue
		}
		if err != nil {
