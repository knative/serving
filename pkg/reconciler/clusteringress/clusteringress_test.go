...
func TestReconcile(t *testing.T) {
	table := TableTest{{
		...
		WantCreates: []runtime.Object{
			resources.MakeMeshVirtualServiceForCusterIngress(ingress("no-virtualservice-yet", 1234)),
		...
		WantCreates: []runtime.Object{
			resources.MakeMeshVirtualServiceForCusterIngress(ingress("reconcile-virtualservice", 1234)),
		},
...
func TestReconcile_EnableAutoTLS(t *testing.T) {
	table := TableTest{{
		...
		WantCreates: []runtime.Object{
			...
			resources.MakeMeshVirtualServiceForCusterIngress(ingress("reconciling-clusteringress", 1234)),
