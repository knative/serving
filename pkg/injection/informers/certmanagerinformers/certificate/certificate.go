...
import (
	...
	"github.com/knative/serving/pkg/injection/informers/certmanagerinformers/factory"
)
...
func Get(ctx context.Context) certmanagerinformers.CertificateInformer {
	return ctx.Value(Key{}).(certmanagerinformers.CertificateInformer)
}
