...
// Get extracts the Knative Service informer from the context.
func Get(ctx context.Context) servinginformers.ServiceInformer {
	return ctx.Value(Key{}).(servinginformers.ServiceInformer)
}
