	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.ServingV1().DomainMappings(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ServingV1().DomainMappings(namespace).Watch(context.TODO(), options)
			},
		},
		&servingv1.DomainMapping{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *domainMappingInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&servingv1.DomainMapping{}, f.defaultInformer)
}

func (f *domainMappingInformer) Lister() v1.DomainMappingLister {
	return v1.NewDomainMappingLister(f.Informer().GetIndexer())
}
