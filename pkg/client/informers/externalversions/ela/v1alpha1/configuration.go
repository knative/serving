...
import (
	...
	v1alpha1 "github.com/elafros/elafros/pkg/client/listers/ela/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ElafrosV1alpha1().Configurations(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ElafrosV1alpha1().Configurations(namespace).Watch(options)
			},
		},
		&ela_v1alpha1.Configuration{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *configurationInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&ela_v1alpha1.Configuration{}, f.defaultInformer)
}
