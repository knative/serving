...
type ServiceLister interface {
	...
	List(selector labels.Selector) (ret []*servingv1.Service, err error)
...
type serviceLister struct {
	listers.ResourceIndexer[*servingv1.Service]
}

// NewServiceLister returns a new ServiceLister.
func NewServiceLister(indexer cache.Indexer) ServiceLister {
	return &serviceLister{listers.New[*servingv1.Service](indexer, servingv1.Resource("service"))}
}

// Services returns an object that can list and get Services.
func (s *serviceLister) Services(namespace string) ServiceNamespaceLister {
	return serviceNamespaceLister{listers.NewNamespaced[*servingv1.Service](s.ResourceIndexer, namespace)}
}
...
type ServiceNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*servingv1.Service, error)
