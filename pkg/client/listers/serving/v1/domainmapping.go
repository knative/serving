...
type DomainMappingLister interface {
	...
	List(selector labels.Selector) (ret []*servingv1.DomainMapping, err error)
...
type domainMappingLister struct {
	listers.ResourceIndexer[*servingv1.DomainMapping]
}
...
func NewDomainMappingLister(indexer cache.Indexer) DomainMappingLister {
	return &domainMappingLister{listers.New[*servingv1.DomainMapping](indexer, servingv1.Resource("domainmapping"))}
}

// DomainMappings returns an object that can list and get DomainMappings.
func (s *domainMappingLister) DomainMappings(namespace string) DomainMappingNamespaceLister {
	return domainMappingNamespaceLister{listers.NewNamespaced[*servingv1.DomainMapping](s.ResourceIndexer, namespace)}
}
...
type DomainMappingNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*servingv1.DomainMapping, error)
