...
type RouteInterface interface {
	Create(*serving.Route) (*serving.Route, error)
	Update(*serving.Route) (*serving.Route, error)
	UpdateStatus(*serving.Route) (*serving.Route, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*serving.Route, error)
	List(opts v1.ListOptions) (*serving.RouteList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *serving.Route, err error)
	RouteExpansion
}
...
func newRoutes(c *ServingClient, namespace string) *routes {
	return &routes{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *routes) Get(name string, options v1.GetOptions) (result *serving.Route, err error) {
...
func (c *routes) List(opts v1.ListOptions) (result *serving.RouteList, err error) {
	result = &serving.RouteList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("routes").
...
func (c *routes) Create(route *serving.Route) (result *serving.Route, err error) {
	result = &serving.Route{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("routes").
...
func (c *routes) Update(route *serving.Route) (result *serving.Route, err error) {
	result = &serving.Route{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("routes").
...
func (c *routes) UpdateStatus(route *serving.Route) (result *serving.Route, err error) {
	result = &serving.Route{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("routes").
...
func (c *routes) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *serving.Route, err error) {
	result = &serving.Route{}
