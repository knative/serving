...
import (
	...
	scheme "knative.dev/serving/pkg/client/serving/clientset/internalversion/scheme"
)
...
type ConfigurationInterface interface {
	Create(*serving.Configuration) (*serving.Configuration, error)
	Update(*serving.Configuration) (*serving.Configuration, error)
	UpdateStatus(*serving.Configuration) (*serving.Configuration, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*serving.Configuration, error)
	List(opts v1.ListOptions) (*serving.ConfigurationList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *serving.Configuration, err error)
...
func newConfigurations(c *ServingClient, namespace string) *configurations {
...
func (c *configurations) Get(name string, options v1.GetOptions) (result *serving.Configuration, err error) {
	result = &serving.Configuration{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *configurations) List(opts v1.ListOptions) (result *serving.ConfigurationList, err error) {
	result = &serving.ConfigurationList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("configurations").
...
func (c *configurations) Create(configuration *serving.Configuration) (result *serving.Configuration, err error) {
	result = &serving.Configuration{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("configurations").
...
func (c *configurations) Update(configuration *serving.Configuration) (result *serving.Configuration, err error) {
	result = &serving.Configuration{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("configurations").
...
func (c *configurations) UpdateStatus(configuration *serving.Configuration) (result *serving.Configuration, err error) {
	result = &serving.Configuration{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("configurations").
...
func (c *configurations) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *serving.Configuration, err error) {
	result = &serving.Configuration{}
