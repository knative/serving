...
type RevisionInterface interface {
	Create(*serving.Revision) (*serving.Revision, error)
	Update(*serving.Revision) (*serving.Revision, error)
	UpdateStatus(*serving.Revision) (*serving.Revision, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*serving.Revision, error)
	List(opts v1.ListOptions) (*serving.RevisionList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *serving.Revision, err error)
	RevisionExpansion
}
...
func newRevisions(c *ServingClient, namespace string) *revisions {
	return &revisions{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *revisions) Get(name string, options v1.GetOptions) (result *serving.Revision, err error) {
	result = &serving.Revision{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("revisions").
		Name(name).
...
func (c *revisions) List(opts v1.ListOptions) (result *serving.RevisionList, err error) {
	result = &serving.RevisionList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("revisions").
...
func (c *revisions) Create(revision *serving.Revision) (result *serving.Revision, err error) {
	result = &serving.Revision{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("revisions").
...
func (c *revisions) Update(revision *serving.Revision) (result *serving.Revision, err error) {
	result = &serving.Revision{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("revisions").
...
func (c *revisions) UpdateStatus(revision *serving.Revision) (result *serving.Revision, err error) {
	result = &serving.Revision{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("revisions").
...
func (c *revisions) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *serving.Revision, err error) {
	result = &serving.Revision{}
