...
import (
	...
	versioned "knative.dev/serving/pkg/client/serving/clientset/versioned"
	internalinterfaces "knative.dev/serving/pkg/client/serving/informers/externalversions/internalinterfaces"
	v1alpha1 "knative.dev/serving/pkg/client/serving/listers/serving/v1alpha1"
)
...
func (f *configurationInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&servingv1alpha1.Configuration{}, f.defaultInformer)
}
