...
type RouteInterface interface {
	Create(ctx context.Context, route *v1beta1.Route, opts v1.CreateOptions) (*v1beta1.Route, error)
	Update(ctx context.Context, route *v1beta1.Route, opts v1.UpdateOptions) (*v1beta1.Route, error)
	UpdateStatus(ctx context.Context, route *v1beta1.Route, opts v1.UpdateOptions) (*v1beta1.Route, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1beta1.Route, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1beta1.RouteList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.Route, err error)
	RouteExpansion
}
...
func (c *routes) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.Route, err error) {
...
func (c *routes) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.RouteList, err error) {
...
func (c *routes) Create(ctx context.Context, route *v1beta1.Route, opts v1.CreateOptions) (result *v1beta1.Route, err error) {
	result = &v1beta1.Route{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("routes").
...
func (c *routes) Update(ctx context.Context, route *v1beta1.Route, opts v1.UpdateOptions) (result *v1beta1.Route, err error) {
	result = &v1beta1.Route{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("routes").
...
func (c *routes) UpdateStatus(ctx context.Context, route *v1beta1.Route, opts v1.UpdateOptions) (result *v1beta1.Route, err error) {
	result = &v1beta1.Route{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("routes").
...
func (c *routes) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.Route, err error) {
	result = &v1beta1.Route{}
