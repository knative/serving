...
func (c *FakeRevisions) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.Revision, err error) {
	obj, err := c.Fake.
...
func (c *FakeRevisions) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.RevisionList, err error) {
	obj, err := c.Fake.
...
func (c *FakeRevisions) Create(ctx context.Context, revision *v1beta1.Revision, opts v1.CreateOptions) (result *v1beta1.Revision, err error) {
	obj, err := c.Fake.
...
func (c *FakeRevisions) Update(ctx context.Context, revision *v1beta1.Revision, opts v1.UpdateOptions) (result *v1beta1.Revision, err error) {
	obj, err := c.Fake.
...
func (c *FakeRevisions) UpdateStatus(ctx context.Context, revision *v1beta1.Revision, opts v1.UpdateOptions) (*v1beta1.Revision, error) {
	obj, err := c.Fake.
...
func (c *FakeRevisions) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.Revision, err error) {
	obj, err := c.Fake.
