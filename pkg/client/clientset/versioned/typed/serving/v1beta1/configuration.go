...
type ConfigurationInterface interface {
	Create(ctx context.Context, configuration *v1beta1.Configuration, opts v1.CreateOptions) (*v1beta1.Configuration, error)
	Update(ctx context.Context, configuration *v1beta1.Configuration, opts v1.UpdateOptions) (*v1beta1.Configuration, error)
	UpdateStatus(ctx context.Context, configuration *v1beta1.Configuration, opts v1.UpdateOptions) (*v1beta1.Configuration, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1beta1.Configuration, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1beta1.ConfigurationList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.Configuration, err error)
...
func (c *configurations) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.ConfigurationList, err error) {
