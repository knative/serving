...
func (c *FakeConfigurations) Get(name string, options v1.GetOptions) (result *servingv1.Configuration, err error) {
	obj, err := c.Fake.
...
func (c *FakeConfigurations) List(opts v1.ListOptions) (result *servingv1.ConfigurationList, err error) {
	obj, err := c.Fake.
...
func (c *FakeConfigurations) Create(configuration *servingv1.Configuration) (result *servingv1.Configuration, err error) {
	obj, err := c.Fake.
...
func (c *FakeConfigurations) Update(configuration *servingv1.Configuration) (result *servingv1.Configuration, err error) {
	obj, err := c.Fake.
...
func (c *FakeConfigurations) UpdateStatus(configuration *servingv1.Configuration) (*servingv1.Configuration, error) {
	obj, err := c.Fake.
...
func (c *FakeConfigurations) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *servingv1.Configuration, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(configurationsResource, c.ns, name, data, subresources...), &servingv1.Configuration{})
