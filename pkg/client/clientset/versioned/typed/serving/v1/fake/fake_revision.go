...
func (c *FakeRevisions) Get(name string, options v1.GetOptions) (result *servingv1.Revision, err error) {
	obj, err := c.Fake.
...
func (c *FakeRevisions) List(opts v1.ListOptions) (result *servingv1.RevisionList, err error) {
	obj, err := c.Fake.
...
func (c *FakeRevisions) Create(revision *servingv1.Revision) (result *servingv1.Revision, err error) {
	obj, err := c.Fake.
...
func (c *FakeRevisions) Update(revision *servingv1.Revision) (result *servingv1.Revision, err error) {
	obj, err := c.Fake.
...
func (c *FakeRevisions) UpdateStatus(revision *servingv1.Revision) (*servingv1.Revision, error) {
	obj, err := c.Fake.
