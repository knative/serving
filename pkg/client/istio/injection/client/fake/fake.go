...
import (
	...
	fake "knative.dev/serving/pkg/client/istio/clientset/versioned/fake"
...
func Get(ctx context.Context) *fake.Clientset {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch knative.dev/serving/pkg/client/istio/clientset/versioned/fake.Clientset from context.")
	}
