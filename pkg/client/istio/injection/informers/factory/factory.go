...
import (
	...
	externalversions "knative.dev/serving/pkg/client/istio/informers/externalversions"
	client "knative.dev/serving/pkg/client/istio/injection/client"
)
...
func Get(ctx context.Context) externalversions.SharedInformerFactory {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch knative.dev/serving/pkg/client/istio/informers/externalversions.SharedInformerFactory from context.")
	}
