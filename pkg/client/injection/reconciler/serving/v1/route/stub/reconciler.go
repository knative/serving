...
//var _ route.ReadOnlyInterface = (*Reconciler)(nil)
...
//var _ route.ReadOnlyFinalizer = (*Reconciler)(nil)
...
// func (r *Reconciler) ObserveKind(ctx context.Context, o *servingv1.Route) reconciler.Event {
...
//func (r *Reconciler) ObserveFinalizeKind(ctx context.Context, o *servingv1.Route) reconciler.Event {
// 	// TODO: add custom observation logic here.
//	return nil
//}
