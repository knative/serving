...
func (r *reconcilerImpl) updateStatus(ctx context.Context, logger *zap.SugaredLogger, existing *v1.Route, desired *v1.Route) error {
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1.Route, desiredFinalizers sets.Set[string]) (*v1.Route, error) {
...
func (r *reconcilerImpl) updateFinalizersFilteredServerSideApply(ctx context.Context, resource *v1.Route, desiredFinalizers sets.Set[string]) (*v1.Route, error) {
...
func (r *reconcilerImpl) updateFinalizersFilteredMergePatch(ctx context.Context, resource *v1.Route, desiredFinalizers sets.Set[string]) (*v1.Route, error) {
	// Don't modify the informers copy.
...
func (r *reconcilerImpl) clearFinalizer(ctx context.Context, resource *v1.Route, reconcileEvent reconciler.Event) (*v1.Route, error) {
	...
	if err != nil {
		...
		getter := r.Client.ServingV1().Routes(resource.Namespace)
