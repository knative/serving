...
func (r *reconcilerImpl) updateStatus(ctx context.Context, logger *zap.SugaredLogger, existing *v1.Revision, desired *v1.Revision) error {
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1.Revision, desiredFinalizers sets.Set[string]) (*v1.Revision, error) {
...
func (r *reconcilerImpl) updateFinalizersFilteredServerSideApply(ctx context.Context, resource *v1.Revision, desiredFinalizers sets.Set[string]) (*v1.Revision, error) {
...
func (r *reconcilerImpl) updateFinalizersFilteredMergePatch(ctx context.Context, resource *v1.Revision, desiredFinalizers sets.Set[string]) (*v1.Revision, error) {
	// Don't modify the informers copy.
...
func (r *reconcilerImpl) clearFinalizer(ctx context.Context, resource *v1.Revision, reconcileEvent reconciler.Event) (*v1.Revision, error) {
	...
	if err != nil {
		...
		getter := r.Client.ServingV1().Revisions(resource.Namespace)
