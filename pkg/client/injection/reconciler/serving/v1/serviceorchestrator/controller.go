...
import (
	...
	serviceorchestrator "knative.dev/serving/pkg/client/injection/informers/serving/v1/serviceorchestrator"
)

const (
	defaultControllerAgentName = "serviceorchestrator-controller"
	defaultFinalizerName       = "serviceorchestrators.serving.knative.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	serviceorchestratorInformer := serviceorchestrator.Get(ctx)

	lister := serviceorchestratorInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "serving.knative.dev.ServiceOrchestrator"),
	)
