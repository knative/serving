...
func (r *reconcilerImpl) updateStatus(ctx context.Context, logger *zap.SugaredLogger, existing *v1.Configuration, desired *v1.Configuration) error {
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1.Configuration, desiredFinalizers sets.Set[string]) (*v1.Configuration, error) {
...
func (r *reconcilerImpl) updateFinalizersFilteredServerSideApply(ctx context.Context, resource *v1.Configuration, desiredFinalizers sets.Set[string]) (*v1.Configuration, error) {
...
func (r *reconcilerImpl) updateFinalizersFilteredMergePatch(ctx context.Context, resource *v1.Configuration, desiredFinalizers sets.Set[string]) (*v1.Configuration, error) {
	// Don't modify the informers copy.
...
func (r *reconcilerImpl) clearFinalizer(ctx context.Context, resource *v1.Configuration, reconcileEvent reconciler.Event) (*v1.Configuration, error) {
	...
	if err != nil {
		...
		getter := r.Client.ServingV1().Configurations(resource.Namespace)
