...
type Interface interface {
	...
	ReconcileKind(ctx context.Context, o *v1.DomainMapping) reconciler.Event
}
...
type Finalizer interface {
	...
	// deletion timestamp.
	FinalizeKind(ctx context.Context, o *v1.DomainMapping) reconciler.Event
}
...
type ReadOnlyInterface interface {
	...
	ObserveKind(ctx context.Context, o *v1.DomainMapping) reconciler.Event
}

type doReconcile func(ctx context.Context, o *v1.DomainMapping) reconciler.Event
...
func (r *reconcilerImpl) updateStatus(ctx context.Context, logger *zap.SugaredLogger, existing *v1.DomainMapping, desired *v1.DomainMapping) error {
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1.DomainMapping, desiredFinalizers sets.String) (*v1.DomainMapping, error) {
	// Don't modify the informers copy.
...
func (r *reconcilerImpl) setFinalizerIfFinalizer(ctx context.Context, resource *v1.DomainMapping) (*v1.DomainMapping, error) {
...
func (r *reconcilerImpl) clearFinalizer(ctx context.Context, resource *v1.DomainMapping, reconcileEvent reconciler.Event) (*v1.DomainMapping, error) {
	if _, ok := r.reconciler.(Finalizer); !ok {
		return resource, nil
	}
	if resource.GetDeletionTimestamp().IsZero() {
