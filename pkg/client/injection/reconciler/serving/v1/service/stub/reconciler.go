...
import (
	...
	service "knative.dev/serving/pkg/client/injection/reconciler/serving/v1/service"
)
...
//var _ service.Finalizer = (*Reconciler)(nil)
...
//var _ service.ReadOnlyInterface = (*Reconciler)(nil)
...
//var _ service.ReadOnlyFinalizer = (*Reconciler)(nil)

// ReconcileKind implements Interface.ReconcileKind.
func (r *Reconciler) ReconcileKind(ctx context.Context, o *servingv1.Service) reconciler.Event {
...
//func (r *Reconciler) FinalizeKind(ctx context.Context, o *servingv1.Service) reconciler.Event {
//	// TODO: add custom finalization logic here.
//	return nil
//}

// Optionally, use ObserveKind to observe the resource when we are not the leader.
// func (r *Reconciler) ObserveKind(ctx context.Context, o *servingv1.Service) reconciler.Event {
...
//func (r *Reconciler) ObserveFinalizeKind(ctx context.Context, o *servingv1.Service) reconciler.Event {
// 	// TODO: add custom observation logic here.
//	return nil
//}
