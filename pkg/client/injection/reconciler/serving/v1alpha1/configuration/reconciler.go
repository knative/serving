...
func (r *reconcilerImpl) updateStatus(existing *v1alpha1.Configuration, desired *v1alpha1.Configuration) error {
	...
	return reconciler.RetryUpdateConflicts(func(attempts int) (err error) {
		...
		if attempts > 0 {
			existing, err = r.Client.ServingV1alpha1().Configurations(desired.Namespace).Get(desired.Name, metav1.GetOptions{})
			if err != nil {
				return err
			}
		}
		...
		_, err = r.Client.ServingV1alpha1().Configurations(existing.Namespace).UpdateStatus(existing)
		return err
	})
}
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.Configuration) (*v1alpha1.Configuration, error) {
	...
	actual, err := r.Lister.Configurations(resource.Namespace).Get(resource.Name)
	if err != nil {
		return resource, err
	}
	...
	resource, err = r.Client.ServingV1alpha1().Configurations(resource.Namespace).Patch(resource.Name, types.MergePatchType, patch)
	if err != nil {
