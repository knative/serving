...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1beta1.DomainMapping, desiredFinalizers sets.String) (*v1beta1.DomainMapping, error) {
	// Don't modify the informers copy.
