...
func (r *reconcilerImpl) updateStatus(ctx context.Context, logger *zap.SugaredLogger, existing *v1beta1.DomainMapping, desired *v1beta1.DomainMapping) error {
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1beta1.DomainMapping, desiredFinalizers sets.Set[string]) (*v1beta1.DomainMapping, error) {
...
func (r *reconcilerImpl) updateFinalizersFilteredServerSideApply(ctx context.Context, resource *v1beta1.DomainMapping, desiredFinalizers sets.Set[string]) (*v1beta1.DomainMapping, error) {
...
func (r *reconcilerImpl) updateFinalizersFilteredMergePatch(ctx context.Context, resource *v1beta1.DomainMapping, desiredFinalizers sets.Set[string]) (*v1beta1.DomainMapping, error) {
	// Don't modify the informers copy.
...
func (r *reconcilerImpl) clearFinalizer(ctx context.Context, resource *v1beta1.DomainMapping, reconcileEvent reconciler.Event) (*v1beta1.DomainMapping, error) {
	...
	if err != nil {
		...
		getter := r.Client.ServingV1beta1().DomainMappings(resource.Namespace)
