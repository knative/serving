...
func (r *reconcilerImpl) updateStatus(ctx context.Context, logger *zap.SugaredLogger, existing *v1alpha1.PodAutoscaler, desired *v1alpha1.PodAutoscaler) error {
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.PodAutoscaler, desiredFinalizers sets.Set[string]) (*v1alpha1.PodAutoscaler, error) {
...
func (r *reconcilerImpl) updateFinalizersFilteredServerSideApply(ctx context.Context, resource *v1alpha1.PodAutoscaler, desiredFinalizers sets.Set[string]) (*v1alpha1.PodAutoscaler, error) {
...
func (r *reconcilerImpl) updateFinalizersFilteredMergePatch(ctx context.Context, resource *v1alpha1.PodAutoscaler, desiredFinalizers sets.Set[string]) (*v1alpha1.PodAutoscaler, error) {
	// Don't modify the informers copy.
...
func (r *reconcilerImpl) clearFinalizer(ctx context.Context, resource *v1alpha1.PodAutoscaler, reconcileEvent reconciler.Event) (*v1alpha1.PodAutoscaler, error) {
	...
	if err != nil {
		...
		getter := r.Client.AutoscalingV1alpha1().PodAutoscalers(resource.Namespace)
