...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.PodAutoscaler, desiredFinalizers sets.String) (*v1alpha1.PodAutoscaler, error) {
	// Don't modify the informers copy.
