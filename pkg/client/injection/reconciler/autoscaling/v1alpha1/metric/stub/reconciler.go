...
import (
	...
	metric "knative.dev/serving/pkg/client/injection/reconciler/autoscaling/v1alpha1/metric"
)

// TODO: PLEASE COPY AND MODIFY THIS FILE AS A STARTING POINT

// newReconciledNormal makes a new reconciler event with event type Normal, and
// reason MetricReconciled.
func newReconciledNormal(namespace, name string) reconciler.Event {
	return reconciler.NewEvent(v1.EventTypeNormal, "MetricReconciled", "Metric reconciled: \"%s/%s\"", namespace, name)
}
...
var _ metric.Interface = (*Reconciler)(nil)

// Optionally check that our Reconciler implements Finalizer
//var _ metric.Finalizer = (*Reconciler)(nil)
...
//var _ metric.ReadOnlyInterface = (*Reconciler)(nil)
...
//var _ metric.ReadOnlyFinalizer = (*Reconciler)(nil)

// ReconcileKind implements Interface.ReconcileKind.
func (r *Reconciler) ReconcileKind(ctx context.Context, o *v1alpha1.Metric) reconciler.Event {
...
//func (r *Reconciler) FinalizeKind(ctx context.Context, o *v1alpha1.Metric) reconciler.Event {
//	// TODO: add custom finalization logic here.
//	return nil
//}

// Optionally, use ObserveKind to observe the resource when we are not the leader.
// func (r *Reconciler) ObserveKind(ctx context.Context, o *v1alpha1.Metric) reconciler.Event {
...
//func (r *Reconciler) ObserveFinalizeKind(ctx context.Context, o *v1alpha1.Metric) reconciler.Event {
// 	// TODO: add custom observation logic here.
//	return nil
//}
