...
func (r *reconcilerImpl) updateStatus(ctx context.Context, logger *zap.SugaredLogger, existing *v1alpha1.Metric, desired *v1alpha1.Metric) error {
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.Metric, desiredFinalizers sets.Set[string]) (*v1alpha1.Metric, error) {
...
func (r *reconcilerImpl) updateFinalizersFilteredServerSideApply(ctx context.Context, resource *v1alpha1.Metric, desiredFinalizers sets.Set[string]) (*v1alpha1.Metric, error) {
...
func (r *reconcilerImpl) updateFinalizersFilteredMergePatch(ctx context.Context, resource *v1alpha1.Metric, desiredFinalizers sets.Set[string]) (*v1alpha1.Metric, error) {
	// Don't modify the informers copy.
...
func (r *reconcilerImpl) clearFinalizer(ctx context.Context, resource *v1alpha1.Metric, reconcileEvent reconciler.Event) (*v1alpha1.Metric, error) {
	...
	if err != nil {
		...
		getter := r.Client.AutoscalingV1alpha1().Metrics(resource.Namespace)
