...
func Get(ctx context.Context) v1.ServiceOrchestratorInformer {
	untyped := ctx.Value(Key{})
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch knative.dev/serving/pkg/client/informers/externalversions/serving/v1.ServiceOrchestratorInformer from context.")
	}
