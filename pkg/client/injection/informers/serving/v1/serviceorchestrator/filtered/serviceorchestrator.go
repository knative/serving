...
func Get(ctx context.Context, selector string) v1.ServiceOrchestratorInformer {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panicf(
			"Unable to fetch knative.dev/serving/pkg/client/informers/externalversions/serving/v1.ServiceOrchestratorInformer with selector %s from context.", selector)
	}
