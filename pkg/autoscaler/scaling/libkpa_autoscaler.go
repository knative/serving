...
func convertSpecToAutoscalerSpec(spec *DeciderSpec) api.AutoscalerSpec {
	// Map scaling metric string to libkpa ScalingMetric type
	var scalingMetric api.ScalingMetric
	switch spec.ScalingMetric {
	case "rps":
		scalingMetric = api.RPS
	default:
