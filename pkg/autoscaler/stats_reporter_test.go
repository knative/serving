...
func TestReporterReport(t *testing.T) {
	...
	expectSuccess(t, "ReportActualPodCount", func() error { return r.ReportActualPodCount(5 /* ready */, 9 /* notReady */, 8 /* terminating */, 6 /* pending */) })
	...
	expectSuccess(t, "ReportActualPodCount", func() error { return r.ReportActualPodCount(7 /* ready */, 0 /* notReady */, 0 /* terminating */, 0 /* pending */) })
	expectSuccess(t, "ReportActualPodCount", func() error { return r.ReportActualPodCount(8 /* ready */, 0 /* notReady */, 0 /* terminating */, 0 /* pending */) })
	expectSuccess(t, "ReportActualPodCount", func() error { return r.ReportActualPodCount(9 /* ready */, 0 /* notReady */, 0 /* terminating */, 0 /* pending */) })
	metricstest.CheckLastValueData(t, "actual_pods", wantTags, 9)

	expectSuccess(t, "ReportActualPodCount", func() error { return r.ReportActualPodCount(0 /* ready */, 6 /* notReady */, 0 /* terminating */, 0 /* pending */) })
	expectSuccess(t, "ReportActualPodCount", func() error { return r.ReportActualPodCount(0 /* ready */, 5 /* notReady */, 0 /* terminating */, 0 /* pending */) })
	expectSuccess(t, "ReportActualPodCount", func() error { return r.ReportActualPodCount(0 /* ready */, 4 /* notReady */, 0 /* terminating */, 0 /* pending */) })
	metricstest.CheckLastValueData(t, "not_ready_pods", wantTags, 4)

	expectSuccess(t, "ReportActualPodCount", func() error { return r.ReportActualPodCount(0 /* ready */, 0 /* notReady */, 0 /* terminating */, 3 /* pending */) })
	expectSuccess(t, "ReportActualPodCount", func() error { return r.ReportActualPodCount(0 /* ready */, 0 /* notReady */, 0 /* terminating */, 2 /* pending */) })
	expectSuccess(t, "ReportActualPodCount", func() error { return r.ReportActualPodCount(0 /* ready */, 0 /* notReady */, 0 /* terminating */, 1 /* pending */) })
	metricstest.CheckLastValueData(t, "pending_pods", wantTags, 1)

	expectSuccess(t, "ReportActualPodCount", func() error { return r.ReportActualPodCount(0 /* ready */, 0 /* notReady */, 5 /* terminating */, 0 /* pending */) })
	expectSuccess(t, "ReportActualPodCount", func() error { return r.ReportActualPodCount(0 /* ready */, 0 /* notReady */, 3 /* terminating */, 0 /* pending */) })
	expectSuccess(t, "ReportActualPodCount", func() error { return r.ReportActualPodCount(0 /* ready */, 0 /* notReady */, 8 /* terminating */, 0/* pending */) })
	metricstest.CheckLastValueData(t, "terminating_pods", wantTags, 8)
