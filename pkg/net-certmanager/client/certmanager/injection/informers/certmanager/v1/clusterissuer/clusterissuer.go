...
func Get(ctx context.Context) v1.ClusterIssuerInformer {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch knative.dev/serving/pkg/net-certmanager/client/certmanager/informers/externalversions/certmanager/v1.ClusterIssuerInformer from context.")
	}
