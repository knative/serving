...
func Get(ctx context.Context, selector string) v1.OrderInformer {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panicf(
			"Unable to fetch knative.dev/serving/pkg/net-certmanager/client/certmanager/informers/externalversions/acme/v1.OrderInformer with selector %s from context.", selector)
	}
