...
import (
	...
	externalversions "knative.dev/serving/pkg/net-certmanager/client/certmanager/informers/externalversions"
	client "knative.dev/serving/pkg/net-certmanager/client/certmanager/injection/client"
)
...
func Get(ctx context.Context, selector string) externalversions.SharedInformerFactory {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panicf(
			"Unable to fetch knative.dev/serving/pkg/net-certmanager/client/certmanager/informers/externalversions.SharedInformerFactory with selector %s from context.", selector)
	}
