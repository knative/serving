...
func TestMarshal(t *testing.T) {
	tests := []struct {
		...
		want: `{"build":{"kind":"Build","apiVersion":"build.knative.dev","metadata":{"creationTimestamp":null},"spec":{"steps":[{"name":"","image":"busybox","resources":{}}],"timeout":"0s"},"status":{"creationTime":null,"startTime":null,"completionTime":null,"stepStates":null,"stepsCompleted":null}}}`,
	}, {
