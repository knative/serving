...
func (source *DomainMapping) ConvertTo(_ context.Context, sink apis.Convertible) error {
	return fmt.Errorf("v1 is the highest known version, got: %T", sink)
}

// ConvertFrom implements apis.Convertible
func (sink *DomainMapping) ConvertFrom(_ context.Context, source apis.Convertible) error {
