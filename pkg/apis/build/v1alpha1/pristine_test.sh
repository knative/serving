...
function test_build {
  OUR_PATH="${RUNFILES}/pkg/apis/build/v1alpha1/build_types.go"
  THEIR_PATH="${RUNFILES}/external/buildcrd/pkg/apis/build/v1alpha1/build_types.go"
...
function test_build_template {
  OUR_PATH="${RUNFILES}/pkg/apis/build/v1alpha1/build_template_types.go"
  THEIR_PATH="${RUNFILES}/external/buildcrd/pkg/apis/build/v1alpha1/build_template_types.go"
...
function test_doc {
  OUR_PATH="${RUNFILES}/pkg/apis/build/v1alpha1/doc.go"
  THEIR_PATH="${RUNFILES}/external/buildcrd/pkg/apis/build/v1alpha1/doc.go"
