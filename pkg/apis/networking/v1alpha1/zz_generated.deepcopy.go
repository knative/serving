...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *IngressVisibility) DeepCopyInto(out *IngressVisibility) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new IngressVisibility.
func (in *IngressVisibility) DeepCopy() *IngressVisibility {
	if in == nil {
		return nil
	}
	out := new(IngressVisibility)
