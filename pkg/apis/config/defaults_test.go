...
func TestDefaultsConfiguration(t *testing.T) {
	...
	configTests := []struct {
		...
		wantDefaults: &Defaults{
			...
			RevisionResponseStartTimeoutSeconds: 60,
		...
		data: map[string]string{
			...
			"revision-response-start-timeout-seconds": "60",
		...
		data: map[string]string{
			"revision-timeout-seconds":                "123",
			"revision-response-start-timeout-seconds": "456",
		},
	}, {
		...
		wantDefaults: &Defaults{
			...
			RevisionResponseStartTimeoutSeconds: 200,
			MaxRevisionTimeoutSeconds:           DefaultMaxRevisionTimeoutSeconds,
			ContainerConcurrencyMaxLimit:        DefaultMaxRevisionContainerConcurrency,
			AllowContainerConcurrencyZero:       DefaultAllowContainerConcurrencyZero,
			EnableServiceLinks:                  ptr.Bool(false),
