...
import (
	...
	fake "knative.dev/serving/pkg/netcertmanager/client/certmanager/clientset/versioned/fake"
...
func Get(ctx context.Context) *fake.Clientset {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch knative.dev/serving/pkg/netcertmanager/client/certmanager/clientset/versioned/fake.Clientset from context.")
	}
