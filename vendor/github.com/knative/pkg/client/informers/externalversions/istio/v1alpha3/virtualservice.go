...
import (
	...
	istio_v1alpha3 "github.com/knative/pkg/apis/istio/v1alpha3"
...
func (f *virtualServiceInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&istio_v1alpha3.VirtualService{}, f.defaultInformer)
}
