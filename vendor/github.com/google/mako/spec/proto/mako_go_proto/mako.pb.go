...
func (AnalysisTriageInfo_EnvironmentType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_b174f87a83ddb952, []int{40, 1}
}
...
func (TestOutput_TestStatus) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_b174f87a83ddb952, []int{48, 0}
}
...
func (TestOutput_RetryableFailureType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_b174f87a83ddb952, []int{48, 1}
}
...
type SamplerRateInfoConfig struct {
	WindowDurationsMs    []int64  `protobuf:"varint,1,rep,name=window_durations_ms,json=windowDurationsMs" json:"window_durations_ms,omitempty"`
	ErrorMessageRegexes  []string `protobuf:"bytes,2,rep,name=error_message_regexes,json=errorMessageRegexes" json:"error_message_regexes,omitempty"`
	CustomEventIds       []string `protobuf:"bytes,3,rep,name=custom_event_ids,json=customEventIds" json:"custom_event_ids,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *SamplerRateInfoConfig) Reset()         { *m = SamplerRateInfoConfig{} }
func (m *SamplerRateInfoConfig) String() string { return proto.CompactTextString(m) }
func (*SamplerRateInfoConfig) ProtoMessage()    {}
func (*SamplerRateInfoConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_b174f87a83ddb952, []int{14}
}

func (m *SamplerRateInfoConfig) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_SamplerRateInfoConfig.Unmarshal(m, b)
}
func (m *SamplerRateInfoConfig) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_SamplerRateInfoConfig.Marshal(b, m, deterministic)
}
func (m *SamplerRateInfoConfig) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SamplerRateInfoConfig.Merge(m, src)
}
func (m *SamplerRateInfoConfig) XXX_Size() int {
	return xxx_messageInfo_SamplerRateInfoConfig.Size(m)
}
func (m *SamplerRateInfoConfig) XXX_DiscardUnknown() {
	xxx_messageInfo_SamplerRateInfoConfig.DiscardUnknown(m)
}

var xxx_messageInfo_SamplerRateInfoConfig proto.InternalMessageInfo

func (m *SamplerRateInfoConfig) GetWindowDurationsMs() []int64 {
	if m != nil {
		return m.WindowDurationsMs
	}
	return nil
}

func (m *SamplerRateInfoConfig) GetErrorMessageRegexes() []string {
	if m != nil {
		return m.ErrorMessageRegexes
	}
	return nil
}

func (m *SamplerRateInfoConfig) GetCustomEventIds() []string {
	if m != nil {
		return m.CustomEventIds
	}
	return nil
}

type SamplerRateInfo struct {
	SamplerExecutionStatistics map[int64]*SamplerRateWindow `protobuf:"bytes,1,rep,name=sampler_execution_statistics,json=samplerExecutionStatistics" json:"sampler_execution_statistics,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	XXX_NoUnkeyedLiteral       struct{}                     `json:"-"`
	XXX_unrecognized           []byte                       `json:"-"`
	XXX_sizecache              int32                        `json:"-"`
}

func (m *SamplerRateInfo) Reset()         { *m = SamplerRateInfo{} }
func (m *SamplerRateInfo) String() string { return proto.CompactTextString(m) }
func (*SamplerRateInfo) ProtoMessage()    {}
func (*SamplerRateInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_b174f87a83ddb952, []int{15}
}

func (m *SamplerRateInfo) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_SamplerRateInfo.Unmarshal(m, b)
}
func (m *SamplerRateInfo) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_SamplerRateInfo.Marshal(b, m, deterministic)
}
func (m *SamplerRateInfo) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SamplerRateInfo.Merge(m, src)
}
func (m *SamplerRateInfo) XXX_Size() int {
	return xxx_messageInfo_SamplerRateInfo.Size(m)
}
func (m *SamplerRateInfo) XXX_DiscardUnknown() {
	xxx_messageInfo_SamplerRateInfo.DiscardUnknown(m)
}

var xxx_messageInfo_SamplerRateInfo proto.InternalMessageInfo

func (m *SamplerRateInfo) GetSamplerExecutionStatistics() map[int64]*SamplerRateWindow {
	if m != nil {
		return m.SamplerExecutionStatistics
	}
	return nil
}

type SamplerRateWindow struct {
	Executions                   *SamplerRateWindow_Stat            `protobuf:"bytes,1,opt,name=executions" json:"executions,omitempty"`
	ExpectedExecutionCount       *int64                             `protobuf:"varint,2,opt,name=expected_execution_count,json=expectedExecutionCount" json:"expected_execution_count,omitempty"`
	SamplePointsReceived         *SamplerRateWindow_Stat            `protobuf:"bytes,3,opt,name=sample_points_received,json=samplePointsReceived" json:"sample_points_received,omitempty"`
	AllErrorsReceived            *SamplerRateWindow_Stat            `protobuf:"bytes,4,opt,name=all_errors_received,json=allErrorsReceived" json:"all_errors_received,omitempty"`
	FilteredErrorsReceivedCounts map[string]*SamplerRateWindow_Stat `protobuf:"bytes,5,rep,name=filtered_errors_received_counts,json=filteredErrorsReceivedCounts" json:"filtered_errors_received_counts,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	CustomEventsCounts           map[string]*SamplerRateWindow_Stat `protobuf:"bytes,6,rep,name=custom_events_counts,json=customEventsCounts" json:"custom_events_counts,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	XXX_NoUnkeyedLiteral         struct{}                           `json:"-"`
	XXX_unrecognized             []byte                             `json:"-"`
	XXX_sizecache                int32                              `json:"-"`
}

func (m *SamplerRateWindow) Reset()         { *m = SamplerRateWindow{} }
func (m *SamplerRateWindow) String() string { return proto.CompactTextString(m) }
func (*SamplerRateWindow) ProtoMessage()    {}
func (*SamplerRateWindow) Descriptor() ([]byte, []int) {
	return fileDescriptor_b174f87a83ddb952, []int{16}
}

func (m *SamplerRateWindow) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_SamplerRateWindow.Unmarshal(m, b)
}
func (m *SamplerRateWindow) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_SamplerRateWindow.Marshal(b, m, deterministic)
}
func (m *SamplerRateWindow) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SamplerRateWindow.Merge(m, src)
}
func (m *SamplerRateWindow) XXX_Size() int {
	return xxx_messageInfo_SamplerRateWindow.Size(m)
}
func (m *SamplerRateWindow) XXX_DiscardUnknown() {
	xxx_messageInfo_SamplerRateWindow.DiscardUnknown(m)
}

var xxx_messageInfo_SamplerRateWindow proto.InternalMessageInfo

func (m *SamplerRateWindow) GetExecutions() *SamplerRateWindow_Stat {
	if m != nil {
		return m.Executions
	}
	return nil
...
func (m *SamplerRateWindow) GetExpectedExecutionCount() int64 {
	if m != nil && m.ExpectedExecutionCount != nil {
		return *m.ExpectedExecutionCount
	}
	return 0
}

func (m *SamplerRateWindow) GetSamplePointsReceived() *SamplerRateWindow_Stat {
	if m != nil {
		return m.SamplePointsReceived
	}
	return nil
}

func (m *SamplerRateWindow) GetAllErrorsReceived() *SamplerRateWindow_Stat {
	if m != nil {
		return m.AllErrorsReceived
	}
	return nil
}

func (m *SamplerRateWindow) GetFilteredErrorsReceivedCounts() map[string]*SamplerRateWindow_Stat {
	if m != nil {
		return m.FilteredErrorsReceivedCounts
	}
	return nil
}

func (m *SamplerRateWindow) GetCustomEventsCounts() map[string]*SamplerRateWindow_Stat {
	if m != nil {
		return m.CustomEventsCounts
	}
	return nil
}

type SamplerRateWindow_Stat struct {
...
func (m *SamplerRateWindow_Stat) Reset()         { *m = SamplerRateWindow_Stat{} }
func (m *SamplerRateWindow_Stat) String() string { return proto.CompactTextString(m) }
func (*SamplerRateWindow_Stat) ProtoMessage()    {}
func (*SamplerRateWindow_Stat) Descriptor() ([]byte, []int) {
	return fileDescriptor_b174f87a83ddb952, []int{16, 0}
}

func (m *SamplerRateWindow_Stat) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_SamplerRateWindow_Stat.Unmarshal(m, b)
}
func (m *SamplerRateWindow_Stat) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_SamplerRateWindow_Stat.Marshal(b, m, deterministic)
}
func (m *SamplerRateWindow_Stat) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SamplerRateWindow_Stat.Merge(m, src)
}
func (m *SamplerRateWindow_Stat) XXX_Size() int {
	return xxx_messageInfo_SamplerRateWindow_Stat.Size(m)
}
func (m *SamplerRateWindow_Stat) XXX_DiscardUnknown() {
	xxx_messageInfo_SamplerRateWindow_Stat.DiscardUnknown(m)
}

var xxx_messageInfo_SamplerRateWindow_Stat proto.InternalMessageInfo

func (m *SamplerRateWindow_Stat) GetCount() int64 {
...
func (*AnalyzerInput_RunBundles) Descriptor() ([]byte, []int) {
	return fileDescriptor_b174f87a83ddb952, []int{38, 0}
}
...
func (*DashboardCompareAggregateChartInput_Series) Descriptor() ([]byte, []int) {
	return fileDescriptor_b174f87a83ddb952, []int{43, 0}
}
...
func (*TestOutput) Descriptor() ([]byte, []int) {
	return fileDescriptor_b174f87a83ddb952, []int{48}
}
...
func (*SampleRecord) Descriptor() ([]byte, []int) {
	return fileDescriptor_b174f87a83ddb952, []int{49}
}
...
func (*SampleFile) Descriptor() ([]byte, []int) {
	return fileDescriptor_b174f87a83ddb952, []int{50}
}
...
func init() {
	...
	proto.RegisterType((*SamplerRateInfoConfig)(nil), "mako.SamplerRateInfoConfig")
	proto.RegisterType((*SamplerRateInfo)(nil), "mako.SamplerRateInfo")
	proto.RegisterMapType((map[int64]*SamplerRateWindow)(nil), "mako.SamplerRateInfo.SamplerExecutionStatisticsEntry")
	proto.RegisterType((*SamplerRateWindow)(nil), "mako.SamplerRateWindow")
	proto.RegisterMapType((map[string]*SamplerRateWindow_Stat)(nil), "mako.SamplerRateWindow.CustomEventsCountsEntry")
	proto.RegisterMapType((map[string]*SamplerRateWindow_Stat)(nil), "mako.SamplerRateWindow.FilteredErrorsReceivedCountsEntry")
	proto.RegisterType((*SamplerRateWindow_Stat)(nil), "mako.SamplerRateWindow.Stat")
...
var fileDescriptor_b174f87a83ddb952 = []byte{
	...
	,
}
