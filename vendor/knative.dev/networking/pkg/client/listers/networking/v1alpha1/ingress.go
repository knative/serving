...
type IngressLister interface {
	...
	List(selector labels.Selector) (ret []*networkingv1alpha1.Ingress, err error)
...
type ingressLister struct {
	listers.ResourceIndexer[*networkingv1alpha1.Ingress]
}

// NewIngressLister returns a new IngressLister.
func NewIngressLister(indexer cache.Indexer) IngressLister {
	return &ingressLister{listers.New[*networkingv1alpha1.Ingress](indexer, networkingv1alpha1.Resource("ingress"))}
}

// Ingresses returns an object that can list and get Ingresses.
func (s *ingressLister) Ingresses(namespace string) IngressNamespaceLister {
	return ingressNamespaceLister{listers.NewNamespaced[*networkingv1alpha1.Ingress](s.ResourceIndexer, namespace)}
}
...
type IngressNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*networkingv1alpha1.Ingress, error)
