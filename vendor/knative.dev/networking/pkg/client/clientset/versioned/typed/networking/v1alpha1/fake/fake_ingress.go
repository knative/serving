...
var ingressesResource = v1alpha1.SchemeGroupVersion.WithResource("ingresses")

var ingressesKind = v1alpha1.SchemeGroupVersion.WithKind("Ingress")
...
func (c *FakeIngresses) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.IngressList, err error) {
	emptyResult := &v1alpha1.IngressList{}
	obj, err := c.Fake.
...
func (c *FakeIngresses) UpdateStatus(ctx context.Context, ingress *v1alpha1.Ingress, opts v1.UpdateOptions) (result *v1alpha1.Ingress, err error) {
	emptyResult := &v1alpha1.Ingress{}
	obj, err := c.Fake.
