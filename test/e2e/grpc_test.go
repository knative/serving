...
type grpcTest func(*testing.T, *v1b1test.ResourceObjects, *test.Clients, string, string)
...
func unaryTest(t *testing.T, resources *v1b1test.ResourceObjects, clients *test.Clients, host, domain string) {
	t.Helper()
...
func streamTest(t *testing.T, resources *v1b1test.ResourceObjects, clients *test.Clients, host, domain string) {
	t.Helper()
	t.Logf("Connecting to grpc-ping using host %q and authority %q", host, domain)
	conn, err := dial(host, domain)
	if err != nil {
...
func testGRPC(t *testing.T, f grpcTest) {
	...
	resources, err := v1b1test.CreateServiceReady(t, clients, &names, rtesting.WithNamedPort("h2c"))
	if err != nil {
...
func TestGRPCUnaryPingFromZero(t *testing.T) {
	testGRPC(t, func(t *testing.T, resources *v1b1test.ResourceObjects, clients *test.Clients, host, domain string) {
