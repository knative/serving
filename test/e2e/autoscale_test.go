...
func TestAutoscaleUpCountPods(t *testing.T) {
	...
	// Increase workload for 2 replicas for 35s
	// Assert the number of expected replicas is between n-1 and n+1, where n is the # of desired replicas for 35s.
	// Assert the number of expected replicas is n and n+1 at the end of 35s, where n is the # of desired replicas.
