...
func TestServiceCreateAndUpdate(t *testing.T) {
	...
	names.Revision, err = v1test.WaitForServiceSingleLatestRevisionReady(clients, names)
	if err != nil {
	...
	if names.Revision, err = v1test.WaitForServiceSingleLatestRevisionReady(clients, names); err != nil {
