...
func TestServiceCreateAndUpdate(t *testing.T) {
	...
	names.Revision, err = v1test.WaitForServiceSingleLatestRevision(clients, names)
	if err != nil {
	...
	if names.Revision, err = v1test.WaitForServiceSingleLatestRevision(clients, names); err != nil {
