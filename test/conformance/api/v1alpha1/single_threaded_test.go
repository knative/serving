...
func TestSingleConcurrency(t *testing.T) {
	...
	client, err := pkgTest.NewSpoofingClient(clients.KubeClient, t.Logf, objects.Service.Status.URL.Host, test.ServingFlags.ResolvableDomain)
	if err != nil {
