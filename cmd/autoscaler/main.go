...
func main() {
	...
	servingInformerFactory := informers.NewSharedInformerFactory(opt.ServingClientSet, time.Hour*10)
	kubeInformerFactory := kubeinformers.NewSharedInformerFactory(opt.KubeClientSet, time.Hour*10)
