...
readonly ISTIO_CRD_YAML=${YAML_REPO_ROOT}/third_party/istio-1.0.4/istio-crds.yaml
readonly ISTIO_YAML=${YAML_REPO_ROOT}/third_party/istio-1.0.4/istio.yaml
readonly ISTIO_LEAN_YAML=${YAML_REPO_ROOT}/third_party/istio-1.0.4/istio-lean.yaml
